...
# # TODO: Deploy server to work remotely
...
def handleExcel():
    ...
    # fixed_url = 'https://pb-import-files.s3-eu-west-1.amazonaws.com/BMBY_export_English.xlsx'
    ...
    # TODO: Connect to PropertyBase API and create the new listings automatically
